...
function draw() {
  ...
  arrangements = [createVector(H, 0, 0),
    createVector(-H, 0, 0),
    createVector(V, 0, 0),
    createVector(-V, 0, 0),
    createVector(0, H, 0),
  ...
  push();
  translate(arrangements[order1]);
  model(P1);
  pop();


  push();
  translate(arrangements[order2])
  model(P2);
  pop();

  push();
  translate(arrangements[order3])
  model(P3);
  pop();

  push();
  translate(arrangements[order4])
  model(P4);
  pop();

  push();
  translate(arrangements[order5])
  model(P5);
  pop();

  push();
  translate(arrangements[order6])
  model(P6);
  pop();

  push();
  translate(arrangements[order7])
  model(P7);
  pop();

  push();
  translate(arrangements[order8])
  model(P8);
  pop();

  push();
  translate(arrangements[order9])
  model(P9);
  pop();

  push();
  translate(arrangements[order10])
  model(P10);
  pop();

  push();
  translate(arrangements[order11])
  model(P11);
  pop();

  push();
  translate(arrangements[order12])
  model(P12);
  pop();

  push();
  translate(arrangements[order13])
  model(P13);
  pop();

  push();
  translate(arrangements[order14])
  model(P14);
  pop();

  push();
  translate(arrangements[order15])
  model(P15);
  pop();

  push();
  translate(arrangements[order16])
  model(P16);
  pop();

  push();
  translate(arrangements[order17])
  model(P17);
  pop();

  push();
  translate(arrangements[order18])
  model(P18);
  pop();

  push();
  translate(arrangements[order19])
  model(P19);
  pop();

  push();
  translate(arrangements[order20])
  model(P20);
  pop();

  push();
  translate(arrangements[order21])
  model(P21);
  pop();

  push();
  translate(arrangements[order22])
  model(P22);
  pop();

  push();
  translate(arrangements[order23])
  model(P23);
  pop();

  push();
  translate(arrangements[order24])
  model(P24);
  pop();
...
function touchMoved() {
  ...
  rotateH = 0.785 + (newRotateAmountX / 100);
  rotateV = 0.52 + ((newRotateAmountY) / 200);
